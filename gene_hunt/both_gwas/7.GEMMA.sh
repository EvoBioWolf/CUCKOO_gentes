...
CHRS=~/EvoBioWolf/CUCKOO_gentes/gene_hunt/gwas/Chromosomes.list
...
if [[ $CHR = 'chr_W' ]]; then
        ...
        #run gemma
        ~/EvoBioWolf/CUCKOO_gentes/gemma-0.98.6-pre1 -bfile ../../beds/${CHR} -k ../../beds/Covariance_Matrix_females.txt -p ${CHR}.phenotypes -lm 1 -o ${CHR} -miss 0.1 -maf 0.01
        ...
        #run gemma
        ~/EvoBioWolf/CUCKOO_gentes/gemma-0.98.6-pre1 -bfile ../../beds/${CHR} -k ../../beds/Covariance_Matrix.txt -p ${CHR}.phenotypes -lm 1 -o ${CHR} -miss 0.1 -maf 0.01
