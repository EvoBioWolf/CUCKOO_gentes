...
#merge autosomes
raw_vcf=/dss/dsslegfs01/pr53da/pr53da-dss-0021/projects/2021__Cuckoo_Resequencing/vcfs/all_samples-2022_11/merged/snps_only
outdir=/dss/dsslegfs01/pr53da/pr53da-dss-0021/projects/2021__Cuckoo_Resequencing/vcfs/all_samples-2022_11/host/gwas_n3/optatus/relatedness
bcftools view --force-samples --file-list Autosomes.list --threads 10 -Oz -o merged_full/autos.vcf.gz
